discard """
  ...
  nimout: '''
tdiagnostic_messages.nim(35, 6) Error: 'a' can have side effects
> tdiagnostic_messages.nim(36, 30) Hint: 'a' calls `.sideEffect` 'callWithSideEffects'
>> tdiagnostic_messages.nim(28, 6) Hint: 'callWithSideEffects' called by 'a'
>> tdiagnostic_messages.nim(30, 34) Hint: 'callWithSideEffects' calls `.sideEffect` 'indirectCallViaVarParam'
>>> tdiagnostic_messages.nim(24, 6) Hint: 'indirectCallViaVarParam' called by 'callWithSideEffects'
...
>>> tdiagnostic_messages.nim(26, 6) Hint: 'indirectCallViaPointer' called by 'callWithSideEffects'
...
>>> tdiagnostic_messages.nim(23, 6) Hint: 'myEcho' called by 'callWithSideEffects'
>> tdiagnostic_messages.nim(33, 3) Hint: 'callWithSideEffects' accesses global state 'globalVar'
>>> tdiagnostic_messages.nim(22, 5) Hint: 'globalVar' accessed by 'callWithSideEffects'
'''
"""
