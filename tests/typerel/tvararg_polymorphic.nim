discard """
  ...
  description: '''
    . From https://github.com/nim-lang/Nim/issues/4799
      varargs broken with polymorphic types
    . currently, it is not possible to pass in subtyped objects
      in varargs arguments
'''
"""

block generic_ref_object:
  type
...
block partially_specialized_generic_ref_object:
  type
...
block specialized_generic_ref_object:
  type
...
block generic_ref_object_access_common_field:
  # knownIssue: this should work
  type
...
block ref_object_access_common_field:
  # knownIssue: this should work
  type
