## Property Based Testing module, importing this module will implement the
## property based testing CLI within your module. Allowing it to be compiled
## and run as a standalone test executable.
...
cli.flagBuilder()
  .name("mode")
  .parser(RunMode, (_, v, var args) => (args.runMode = v))
